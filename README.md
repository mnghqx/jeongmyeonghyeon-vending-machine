...
디지털 인터페이스라면 더 간편하게 단순화할 수도 있었지만, 이번 과제의 의도를 “자판기의 아날로그 사용성을 얼마나 자연스럽게 디지털로 옮길 수 있는지”로 해석하고, 실제 자판기에서 느껴지는 작은 불편함과 제약들도 의도적으로 유지했습니다.

> ## AI 사용 내역
>
> 이 과제 구현 과정에서 ChatGPT(GPT-5.1 Thinking)를 다음과 같은 방식으로 참고했습니다.
>
...
> - respinner 데모 페이지 스타일을 참고하여, 전체 레이아웃(좌측 자판기 패널 / 우측 결제 패널)과 버튼·카드·메시지 영역의 톤앤매너를 잡고 CSS를 다듬을 때 조언을 받았습니다.
